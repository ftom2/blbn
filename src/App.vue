<template>
<v-app>
  <v-alert :color="alert.type" v-show="alert.message" value="true" transition="scale-transition" class="app-alert">
    {{alert.message}}
  </v-alert>
  ...
  <v-toolbar app color="green" dark v-if="userIsAuthenticated" class="print-hide">
    ...
    <v-toolbar-items class="hidden-sm-and-down" v-for="item in menuItems" :key="item.icon">
